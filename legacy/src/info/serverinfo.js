...
exports.run = (client, message, args, level) => {
  ...
  const embed = new Discord.RichEmbed()
    .setAuthor(
      'ServerInfo',
      'https://images-ext-1.discordapp.net/external/G8xAvybO-2B80GxsmWm-LqeaRYp8SZU2ubfkW6Xfohc/https/images-ext-1.discordapp.net/external/kM10hRmnturbyk0Ud6zH6jhaAbUqooXR4RQipiZe5uw/https/images-ext-2.discordapp.net/external/87rdv6EfrkeXrS8LRQ5BD91sL2226HzG5VWdncuVsw0/https/i.imgur.com/RHagTDg.png'
    )
    .setColor('RANDOM')
...
exports.help = {
  ...
  category: 'General',
  extended:
    'This command will return an organised embed with server information and statistics.'
};
